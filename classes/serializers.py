...
class ClassSerializer(serializers.ModelSerializer):
    ...
    type_id = serializers.PrimaryKeyRelatedField(source='type', queryset=ClassType.objects.all())
    teacher_id = serializers.PrimaryKeyRelatedField(source='teacher', queryset=User.objects.all())  # TODO: ADD roles
    group_ids = serializers.PrimaryKeyRelatedField(source='groups', queryset=Group.objects.all(), many=True)
...
class CourseSerializer(serializers.ModelSerializer):
    ...
    year_group_id = serializers.PrimaryKeyRelatedField(source="year_group", queryset=YearGroup.objects.all())
